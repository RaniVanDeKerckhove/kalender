var cal = {
  ...
  hID:null, hStart:null, hEnd:null, hTxt:null, hTxt2:null, hTxt3:null, hTxt4:null, hColor:null,
  init : () => {
    ...
    cal.hTxt2 = document.getElementById("evttxt2");
    cal.hTxt3 = document.getElementById("evttxt3");
    cal.hTxt4 = document.getElementById("evttxt4");
    cal.hTxt5 = document.getElementById("evttxt5");
  ...
  show : (cell) => {
    ...
    // (D2) EDIT EVENT
      ...
      cal.hTxt.value = edata["evt_trainer"];
      cal.hTxt2.value = edata["evt_lokaal"];
      cal.hTxt3.value = edata["evt_bezigheid"];
      cal.hTxt4.value = edata["evt_materiaal"];
      cal.hTxt5.value = edata["evt_andere"];
